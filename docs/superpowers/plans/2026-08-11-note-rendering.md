...
**仕様:** [docs/superpowers/specs/2026-08-11-note-rendering-design.md](../specs/2026-08-11-note-rendering-design.md)。**タスクの記述と仕様が食い違ったら仕様が正。**
...
- [ ] **Step 2〜4: 走らせて落ちる → 実装 → ゲートと変異検証、コミット**
...
- [ ] **Step 2: `NoteFull` / `NoteCompact` を組み直す**
